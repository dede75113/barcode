...
// Hello - ANSI MH10.8M-1983 - USD-3 - 3 of 9.
$pdf->Cell(0, 0, 'Hello - ANSI MH10.8M-1983 - USD-3 - 3 of 9', 0, 1);
$pdf->write1DBarcode('Hello', 'C39', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// Hello + CHECKSUM
$pdf->Cell(0, 0, 'Hello + CHECKSUM', 0, 1);
$pdf->write1DBarcode('Hello +', 'C39+', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// Hello EXTENDED
$pdf->Cell(0, 0, 'Hello EXTENDED', 0, 1);
$pdf->write1DBarcode('Hello E', 'C39E', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln();

// Hello EXTENDED + CHECKSUM
$pdf->Cell(0, 0, 'Hello EXTENDED + CHECKSUM', 0, 1);
$pdf->write1DBarcode('Hello E+', 'C39E+', '', '', '', 18, 0.4, $style, 'N');
...
$pdf->write1DBarcode('Hello E+', 'C39E+', '', '', 120, 25, 0.4, $style, 'N');
